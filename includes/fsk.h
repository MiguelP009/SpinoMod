...
void fskModulate(s_vco *vco_config, uint8_t *input_data, size_t len_input_data, float **samples, size_t *samples_len){
    ...
    float *input_data_interpolated = malloc(len_input_data * 8 * MODULATION_INTERPOLATION * sizeof(float));
    ...
    float *i_out = malloc(len_input_data * 8 * MODULATION_INTERPOLATION * sizeof(float));
    float *q_out = malloc(len_input_data * 8 * MODULATION_INTERPOLATION * sizeof(float));
